...
@Entity
@Table(name = "fuel_data_2026")
public class FuelData2026 {
    ...
    public FuelData2026(String vendor, String vehiclePlateNumber, String transactionDate, float unitPrice, float volume,
