...
@Entity
@Table(name = "fuel_data_2025")
public class FuelData2025 {
    ...
    public FuelData2025(String vendor, String vehiclePlateNumber, String transactionDate, float unitPrice, float volume,
