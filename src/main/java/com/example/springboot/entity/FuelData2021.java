...
@Entity
@Table(name = "fuel_data_2021")
public class FuelData2021 {
    ...
    public FuelData2021(String vendor, String vehiclePlateNumber, String transactionDate, float unitPrice, float volume,
