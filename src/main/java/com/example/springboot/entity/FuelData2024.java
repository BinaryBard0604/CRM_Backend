...
@Entity
@Table(name = "fuel_data_2024")
public class FuelData2024 {
    ...
    public FuelData2024(String vendor, String vehiclePlateNumber, String transactionDate, float unitPrice, float volume,
