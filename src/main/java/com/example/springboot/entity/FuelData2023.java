...
@Entity
@Table(name = "fuel_data_2023")
public class FuelData2023 {
    ...
    public FuelData2023(String vendor, String vehiclePlateNumber, String transactionDate, float unitPrice, float volume,
